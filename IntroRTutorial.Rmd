...
* press the following keys, holding them all down (you'll need to use four fingers for this!): **ctr + shift + alt + A**
![ctrshiftaltA](images/IntroR_ctraltshiftA.png){width="60"} 

* **deselect** all but the last Network Method and **click OK**
![Select network method](images/IntroR_selnetmeth.png){width="60"} 
